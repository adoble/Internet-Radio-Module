...
encoding utf-8
Sheet 6 6
Title "Internet Radio Module - Main Processor"
Date "2019-11-07"
Rev ""
Comp "Andrew Doble"
Comment1 ""
...
U 1 1 5DBA1F7A
P 4350 5850
AR Path="/5DBA1F7A" Ref="#PWR?"  Part="1" 
AR Path="/5DB85C19/5DBA1F7A" Ref="#PWR058"  Part="1" 
F 0 "#PWR058" H 4350 5600 50  0001 C CNN
...
U 1 1 5DBA1F81
P 3850 5850
AR Path="/5DBA1F81" Ref="#FLG?"  Part="1" 
AR Path="/5DB85C19/5DBA1F81" Ref="#FLG01"  Part="1" 
F 0 "#FLG01" H 3850 5925 50  0001 C CNN
F 1 "PWR_FLAG" V 3850 5977 50  0000 L CNN
...
U 1 1 5DBA1F89
P 3700 1850
AR Path="/5DBA1F89" Ref="#PWR?"  Part="1" 
AR Path="/5DB85C19/5DBA1F89" Ref="#PWR055"  Part="1" 
F 0 "#PWR055" H 3700 1700 50  0001 C CNN
...
U 1 1 5DBA1F8F
P 6250 4000
AR Path="/5DBA1F8F" Ref="#PWR?"  Part="1" 
AR Path="/5DB85C19/5DBA1F8F" Ref="#PWR061"  Part="1" 
F 0 "#PWR061" H 6250 3750 50  0001 C CNN
...
U 1 1 5DBA1F96
P 3950 1950
AR Path="/5DBA1F96" Ref="#PWR?"  Part="1" 
AR Path="/5DB85C19/5DBA1F96" Ref="#PWR057"  Part="1" 
F 0 "#PWR057" H 3950 1700 50  0001 C CNN
...
IO33
Text Label 4650 5400 3    60   ~ 0
XDCS/IO27
Text Label 4750 5400 3    60   ~ 0
DREQ/IO26
Text Label 4850 5450 3    60   ~ 0
XCS/IO25
...
IO13
Text Label 4250 4650 3    60   ~ 0
IO12
Text Label 4150 4650 3    60   ~ 0
IO5
Text Label 4050 4800 1    60   ~ 0
IO4
Text Label 3950 4650 3    60   ~ 0
IO2
Text Label 3750 4600 3    60   ~ 0
RXDO
Text Label 3650 4600 3    60   ~ 0
TXD0
...
U 1 1 5DBA2004
P 3650 5550
AR Path="/5DBA2004" Ref="#PWR?"  Part="1" 
AR Path="/5DB85C19/5DBA2004" Ref="#PWR054"  Part="1" 
F 0 "#PWR054" H 3650 5400 50  0001 C CNN
F 1 "+3.3V" H 3650 5690 50  0000 C CNN
...
U 1 1 5DBA200B
P 3850 5850
AR Path="/5DBA200B" Ref="#PWR?"  Part="1" 
AR Path="/5DB85C19/5DBA200B" Ref="#PWR056"  Part="1" 
F 0 "#PWR056" H 3850 5600 50  0001 C CNN
...
U 1 1 5DBA201E
P 3100 2850
AR Path="/5DBA201E" Ref="#PWR?"  Part="1" 
AR Path="/5DB85C19/5DBA201E" Ref="#PWR053"  Part="1" 
F 0 "#PWR053" H 3100 2600 50  0001 C CNN
...
U 1 1 5DBA2024
P 3100 2650
AR Path="/5DBA2024" Ref="SW?"  Part="1" 
AR Path="/5DB85C19/5DBA2024" Ref="SW1"  Part="1" 
F 0 "SW1" H 3150 2750 50  0000 L CNN
F 1 "RST" H 3100 2590 50  0000 C CNN
F 2 "irm_pcb:SW-PUSH-RND-SMALL" H 3100 2850 50  0001 C CNN
...
U 1 1 5DBA202A
P 3450 2150
AR Path="/5DBA202A" Ref="R?"  Part="1" 
AR Path="/5DB85C19/5DBA202A" Ref="R14"  Part="1" 
F 0 "R14" V 3530 2150 50  0000 C CNN
...
IO2
Text Label 5350 4350 1    60   ~ 0
IO15
Text Label 4650 4350 1    60   ~ 0
IO13
...
U 1 1 5DBA2049
P 6250 3800
AR Path="/5DBA2049" Ref="SW?"  Part="1" 
AR Path="/5DB85C19/5DBA2049" Ref="SW2"  Part="1" 
F 0 "SW2" H 6300 3900 50  0000 L CNN
F 1 "0" H 6250 3740 50  0000 C CNN
F 2 "irm_pcb:SW-PUSH-RND-SMALL" H 6250 4000 50  0001 C CNN
...
U 1 1 5DBA2054
P 4400 4150
AR Path="/5DBA2054" Ref="#PWR?"  Part="1" 
AR Path="/5DB85C19/5DBA2054" Ref="#PWR059"  Part="1" 
F 0 "#PWR059" H 4400 3900 50  0001 C CNN
...
$EndComp
$Comp
L modular-internet-radio:ESP32-WROOM-32 U?
U 1 1 5DBA205A
P 5000 2800
AR Path="/5DBA205A" Ref="U?"  Part="1" 
AR Path="/5DB85C19/5DBA205A" Ref="U5"  Part="1" 
F 0 "U5" H 4450 3850 60  0000 C CNN
F 1 "ESP32-WROOM-32" H 4950 3550 60  0000 C CNN
F 2 "irm_pcb:ESP32-WROOM-32-Espressif-Symbol-Kicad-62379" H 5050 2700 60  0001 C CNN
...
U 1 1 5DBA2063
P 6000 1950
AR Path="/5DBA2063" Ref="#PWR?"  Part="1" 
AR Path="/5DB85C19/5DBA2063" Ref="#PWR060"  Part="1" 
F 0 "#PWR060" H 6000 1700 50  0001 C CNN
...
DREQ
Text HLabel 3300 3350 0    50   Output ~ 0
XDCS
...
U 1 1 5DBB6138
P 4350 5150
F 0 "J9" V 4446 4362 50  0000 R CNN
F 1 "Conn_02x15_Top_Bottom" V 4355 4362 50  0000 R CNN
F 2 "irm_pcb:Pin_Header_Straight_2x15_Pitch2.54mm" H 4350 5150 50  0001 C CNN
F 3 "~" H 4350 5150 50  0001 C CNN
F 4 "Female" V 4350 5150 50  0000 R CNN "Note"
	1    4350 5150
	0    -1   -1   0   
$EndComp
...
U 1 1 5DBF73C6
P 6900 5450
F 0 "J17" H 6818 4835 50  0000 C CNN
F 1 "Conn_01x06" H 6818 4926 50  0000 C CNN
F 2 "Pin_Headers:Pin_Header_Straight_1x06_Pitch2.54mm" H 6900 5450 50  0001 C CNN
F 3 "~" H 6900 5450 50  0001 C CNN
F 4 "Male" H 6818 5017 50  0000 C CNN "Note"
	1    6900 5450
	-1   0    0    1   
$EndComp
Wire Wire Line
...
U 1 1 5DBFBCA8
P 7100 5650
AR Path="/5DBFBCA8" Ref="#PWR?"  Part="1" 
AR Path="/5DB85C19/5DBFBCA8" Ref="#PWR065"  Part="1" 
F 0 "#PWR065" H 7100 5400 50  0001 C CNN
...
U 1 1 5DC01828
P 7450 5450
AR Path="/5DC01828" Ref="#PWR?"  Part="1" 
AR Path="/5DB85C19/5DC01828" Ref="#PWR066"  Part="1" 
F 0 "#PWR066" H 7450 5300 50  0001 C CNN
...
U 1 1 5DFD3A19
P 2850 4350
AR Path="/5DFD3A19" Ref="#PWR?"  Part="1" 
AR Path="/5DB85C19/5DFD3A19" Ref="#PWR0106"  Part="1" 
...
U 1 1 5DFD3465
P 2850 4050
AR Path="/5DFD3465" Ref="#PWR?"  Part="1" 
AR Path="/5DB85C19/5DFD3465" Ref="#PWR0107"  Part="1" 
...
U 1 1 5DFCEEB1
P 3000 4200
F 0 "C24" H 3115 4246 50  0000 L CNN
...
U 1 1 5DFCEAA0
P 2650 4200
F 0 "C22" H 2765 4246 50  0000 L CNN
F 1 "10u" H 2765 4155 50  0000 L CNN
